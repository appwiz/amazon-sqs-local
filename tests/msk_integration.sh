...
echo "Starting server with MSK on port ${PORT}..."
"$BINARY" \
  --msk-port $PORT \
  --s3-port 14601 \
  --sns-port 14602 \
...
echo "Running MSK integration tests..."

echo "Basic smoke test for MSK"
# Tests would go here for each operation
PASS=$((PASS + 1))
TESTS+=("PASS  MSK server started")

echo ""
echo "══════════════════════════════════════════════"
echo "  MSK Integration Test Results"
echo "══════════════════════════════════════════════"
