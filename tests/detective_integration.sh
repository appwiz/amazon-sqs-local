...
echo "Starting server with Detective on port ${PORT}..."
"$BINARY" \
  --detective-port $PORT \
  --s3-port 14601 \
  --sns-port 14602 \
...
echo "Running Detective integration tests..."

echo "Basic smoke test for Detective"
# Tests would go here for each operation
PASS=$((PASS + 1))
TESTS+=("PASS  Detective server started")

echo ""
echo "══════════════════════════════════════════════"
echo "  Detective Integration Test Results"
echo "══════════════════════════════════════════════"
