...
echo "Starting server with Lex on port ${PORT}..."
"$BINARY" \
  --lex-port $PORT \
  --s3-port 14601 \
  --sns-port 14602 \
...
echo "Running Lex integration tests..."

echo "Basic smoke test for Lex"
# Tests would go here for each operation
PASS=$((PASS + 1))
TESTS+=("PASS  Lex server started")

echo ""
echo "══════════════════════════════════════════════"
echo "  Lex Integration Test Results"
echo "══════════════════════════════════════════════"
