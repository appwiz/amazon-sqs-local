...
echo "Starting server with SWF on port ${PORT}..."
"$BINARY" \
  --swf-port $PORT \
  --s3-port 14601 \
  --sns-port 14602 \
...
echo "Running SWF integration tests..."

echo "Basic smoke test for SWF"
# Tests would go here for each operation
PASS=$((PASS + 1))
TESTS+=("PASS  SWF server started")

echo ""
echo "══════════════════════════════════════════════"
echo "  SWF Integration Test Results"
echo "══════════════════════════════════════════════"
