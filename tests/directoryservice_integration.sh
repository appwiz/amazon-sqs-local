...
echo "Starting server with DirectoryService on port ${PORT}..."
"$BINARY" \
...
echo "Running DirectoryService integration tests..."

echo "Basic smoke test for DirectoryService"
# Tests would go here for each operation
PASS=$((PASS + 1))
TESTS+=("PASS  DirectoryService server started")

echo ""
echo "══════════════════════════════════════════════"
echo "  DirectoryService Integration Test Results"
echo "══════════════════════════════════════════════"
