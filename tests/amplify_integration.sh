...
echo "Starting server with Amplify on port ${PORT}..."
"$BINARY" \
  --amplify-port $PORT \
  --s3-port 14601 \
  --sns-port 14602 \
...
echo "Running Amplify integration tests..."

echo "Basic smoke test for Amplify"
# Tests would go here for each operation
PASS=$((PASS + 1))
TESTS+=("PASS  Amplify server started")

echo ""
echo "══════════════════════════════════════════════"
echo "  Amplify Integration Test Results"
echo "══════════════════════════════════════════════"
