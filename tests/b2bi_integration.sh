...
echo "Starting server with B2BI on port ${PORT}..."
"$BINARY" \
  --b2bi-port $PORT \
  --s3-port 14601 \
  --sns-port 14602 \
...
echo "Running B2BI integration tests..."

echo "Basic smoke test for B2BI"
# Tests would go here for each operation
PASS=$((PASS + 1))
TESTS+=("PASS  B2BI server started")

echo ""
echo "══════════════════════════════════════════════"
echo "  B2BI Integration Test Results"
echo "══════════════════════════════════════════════"
