...
echo "Starting server with ECS on port ${PORT}..."
"$BINARY" \
  --ecs-port $PORT \
  --s3-port 14601 \
  --sns-port 14602 \
...
echo "Basic smoke test for ECS"
# Tests would go here for each operation
PASS=$((PASS + 1))
TESTS+=("PASS  ECS server started")

echo ""
echo "══════════════════════════════════════════════"
echo "  ECS Integration Test Results"
echo "══════════════════════════════════════════════"
