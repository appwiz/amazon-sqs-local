...
echo "Starting server with Budgets on port ${PORT}..."
"$BINARY" \
  --budgets-port $PORT \
  --s3-port 14601 \
  --sns-port 14602 \
...
echo "Running Budgets integration tests..."

echo "Basic smoke test for Budgets"
# Tests would go here for each operation
PASS=$((PASS + 1))
TESTS+=("PASS  Budgets server started")

echo ""
echo "══════════════════════════════════════════════"
echo "  Budgets Integration Test Results"
echo "══════════════════════════════════════════════"
