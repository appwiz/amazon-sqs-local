...
echo "Starting server with WorkMail on port ${PORT}..."
"$BINARY" \
  --workmail-port $PORT \
  --s3-port 14601 \
  --sns-port 14602 \
...
echo "Running WorkMail integration tests..."

echo "Basic smoke test for WorkMail"
# Tests would go here for each operation
PASS=$((PASS + 1))
TESTS+=("PASS  WorkMail server started")

echo ""
echo "══════════════════════════════════════════════"
echo "  WorkMail Integration Test Results"
echo "══════════════════════════════════════════════"
