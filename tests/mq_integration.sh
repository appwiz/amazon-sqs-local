...
echo "Starting server with MQ on port ${PORT}..."
"$BINARY" \
  --mq-port $PORT \
  --s3-port 14601 \
  --sns-port 14602 \
...
echo "Running MQ integration tests..."

echo "Basic smoke test for MQ"
# Tests would go here for each operation
PASS=$((PASS + 1))
TESTS+=("PASS  MQ server started")

echo ""
echo "══════════════════════════════════════════════"
echo "  MQ Integration Test Results"
echo "══════════════════════════════════════════════"
