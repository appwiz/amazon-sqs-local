...
echo "Starting server with MediaLive on port ${PORT}..."
"$BINARY" \
  --medialive-port $PORT \
  --s3-port 14601 \
  --sns-port 14602 \
...
echo "Running MediaLive integration tests..."

echo "Basic smoke test for MediaLive"
# Tests would go here for each operation
PASS=$((PASS + 1))
TESTS+=("PASS  MediaLive server started")

echo ""
echo "══════════════════════════════════════════════"
echo "  MediaLive Integration Test Results"
echo "══════════════════════════════════════════════"
