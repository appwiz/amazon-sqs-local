...
echo "Starting server with Redshift on port ${PORT}..."
"$BINARY" \
  --redshift-port $PORT \
  --s3-port 14601 \
  --sns-port 14602 \
...
echo "Basic smoke test for Redshift"
# Tests would go here for each operation
PASS=$((PASS + 1))
TESTS+=("PASS  Redshift server started")

echo ""
echo "══════════════════════════════════════════════"
echo "  Redshift Integration Test Results"
echo "══════════════════════════════════════════════"
