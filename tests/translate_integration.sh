...
echo "Starting server with Translate on port ${PORT}..."
"$BINARY" \
  --translate-port $PORT \
  --s3-port 14601 \
  --sns-port 14602 \
...
echo "Running Translate integration tests..."

echo "Basic smoke test for Translate"
# Tests would go here for each operation
PASS=$((PASS + 1))
TESTS+=("PASS  Translate server started")

echo ""
echo "══════════════════════════════════════════════"
echo "  Translate Integration Test Results"
echo "══════════════════════════════════════════════"
