...
use super::state::MedialiveState;
use super::types::*;

async fn create_channel_handler(
    State(state): State<Arc<MedialiveState>>,
    Json(req): Json<CreateChannelRequest>,
) -> Result<axum::response::Response, MedialiveError> {
...
pub fn create_router(state: Arc<MedialiveState>) -> Router {
    Router::new()
...
mod tests {
    ...
    async fn test_list_endpoint() {
        let state = Arc::new(MedialiveState::new("123456789012".to_string(), "us-east-1".to_string()));
