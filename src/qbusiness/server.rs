...
use super::state::QbusinessState;
use super::types::*;

async fn create_application_handler(
    State(state): State<Arc<QbusinessState>>,
    Json(req): Json<CreateApplicationRequest>,
) -> Result<axum::response::Response, QbusinessError> {
...
pub fn create_router(state: Arc<QbusinessState>) -> Router {
    Router::new()
...
mod tests {
    ...
    async fn test_list_endpoint() {
        let state = Arc::new(QbusinessState::new("123456789012".to_string(), "us-east-1".to_string()));
