...
use super::state::DatazoneState;
use super::types::*;

async fn create_domain_handler(
    State(state): State<Arc<DatazoneState>>,
    Json(req): Json<CreateDomainRequest>,
) -> Result<axum::response::Response, DatazoneError> {
...
pub fn create_router(state: Arc<DatazoneState>) -> Router {
    Router::new()
...
mod tests {
    ...
    async fn test_list_endpoint() {
        let state = Arc::new(DatazoneState::new("123456789012".to_string(), "us-east-1".to_string()));
