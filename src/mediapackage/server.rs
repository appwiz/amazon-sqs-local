...
use super::state::MediapackageState;
use super::types::*;

async fn create_channel_handler(
    State(state): State<Arc<MediapackageState>>,
    Json(req): Json<CreateChannelRequest>,
) -> Result<axum::response::Response, MediapackageError> {
...
pub fn create_router(state: Arc<MediapackageState>) -> Router {
    Router::new()
...
mod tests {
    ...
    async fn test_list_endpoint() {
        let state = Arc::new(MediapackageState::new("123456789012".to_string(), "us-east-1".to_string()));
