...
use super::state::IottwinmakerState;
use super::types::*;

async fn create_workspace_handler(
    State(state): State<Arc<IottwinmakerState>>,
    Json(req): Json<CreateWorkspaceRequest>,
) -> Result<axum::response::Response, IottwinmakerError> {
...
pub fn create_router(state: Arc<IottwinmakerState>) -> Router {
    Router::new()
...
mod tests {
    ...
    async fn test_list_endpoint() {
        let state = Arc::new(IottwinmakerState::new("123456789012".to_string(), "us-east-1".to_string()));
