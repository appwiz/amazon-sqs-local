...
use super::state::AmplifyState;
use super::types::*;

async fn create_app_handler(
    State(state): State<Arc<AmplifyState>>,
    Json(req): Json<CreateAppRequest>,
) -> Result<axum::response::Response, AmplifyError> {
...
pub fn create_router(state: Arc<AmplifyState>) -> Router {
    Router::new()
...
mod tests {
    ...
    async fn test_list_endpoint() {
        let state = Arc::new(AmplifyState::new("123456789012".to_string(), "us-east-1".to_string()));
