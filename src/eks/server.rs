...
pub fn create_router(state: Arc<EKSState>) -> Router {
    Router::new()
...
mod tests {
    ...
    async fn test_list_endpoint() {
        let state = Arc::new(EKSState::new("123456789012".to_string(), "us-east-1".to_string()));
